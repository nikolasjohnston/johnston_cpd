...
Student evaluation data indicates strong performance in areas relating to clarity of assessment expectations, with mean scores typically above **5.5/6.0**, suggesting that students understand what is required and how their work will be evaluated.
...
These changes reflect a shift toward **assessment for learning** [@boud2006; @nicol2006], where feedback is integrated throughout the learning process rather than occurring solely at the end.

---

## UDL and Cognitive Load

Assessment design is also informed by principles of **Universal Design for Learning** and **cognitive load theory** [@sweller1988]. Tasks are structured to prioritise conceptual understanding over technical reproduction, ensuring that students are assessed on their ability to interpret data, justify decisions, and communicate meaning — rather than on prior experience with coding or technical syntax. The staged nature of assessment further reduces cognitive overload by breaking complex tasks into manageable components, supporting a diverse cohort with varying levels of preparedness.
...
**Previous:** [Qualifier 3 — Learning Pathways](cpd3.qmd) · **Next:** [Qualifier 5 — Scholarship of T&L](cpd5.qmd)
